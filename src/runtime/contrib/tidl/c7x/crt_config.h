...
/*!
 * \file  src/runtime/contrib/tidl/c7x/crt_config.h
 * \brief Adapted from apps/bundle_deploy/crt_config.h
 *        CRT configuration for C7x TVM C runtime.
 */
...
/*! Maximum supported arguments in generated functions */ /* C7x customization */
#define TVM_CRT_MAX_ARGS (32+32)
/*! Maximum supported string length in dltype, e.g. "int8", "int16", "float32" */
#define TVM_CRT_MAX_STRLEN_DLTYPE 10
/*! Maximum supported string length in function names */
#define TVM_CRT_MAX_STRLEN_FUNCTION_NAME 128
