...
# ---------------------------------------------
def run_module(model_name, input_tensor, input_data):
...
if __name__ == '__main__':
    ...
    input_data = np.ones((1, 480, 14, 14), "float32")

    outputs   = run_module("ovx_tvm_c7x", "data", input_data)
    outputs_l = run_module("ovx_tvm_large_c7x", "data", input_data)

    print(input_data)
    print(outputs[0])
    print(outputs_l[0].flatten())
