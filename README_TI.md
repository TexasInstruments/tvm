...
==============================================
[Documentation](https://software-dl.ti.com/codegen/docs/tvm/tvm_tidl_users_guide/index.html) |
[Release Notes](https://software-dl.ti.com/codegen/docs/tvm/tvm_tidl_users_guide/release-notes.html)
...
Getting Started
---------------
Refer to [Gettting Started](https://software-dl.ti.com/codegen/docs/tvm/tvm_tidl_users_guide/getting-started/index.html) in the TI TVM User's Guide.

Building TVM
------------
TI's TVM releases are synchronized with TI's [Processor SDK RTOS](https://www.ti.com/tool/download/PROCESSOR-SDK-RTOS-J721E) releases. Refer to [Building from Source](https://software-dl.ti.com/codegen/docs/tvm/tvm_tidl_users_guide/building.html) in the TI TVM User's Guide.

Release Notes
-------------
Refer to [Release Notes](https://software-dl.ti.com/codegen/docs/tvm/tvm_tidl_users_guide/release-notes.html) in the TI TVM User's Guide.